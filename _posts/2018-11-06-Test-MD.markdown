...
Jekyll kramdown + mathjax test (updated `gemfile` - 2019-09-23)
...
* **AsciiMath2jax** (`''` or `€€`) - see <http://www.wjagray.co.uk/maths/SymbolList.html> and use "`''<space>...<space>''`" as defined in <https://github.com/andrzejQ/jekyll_1> `_includes/mathjs { asciimath2jax: {delimiters:...`:
